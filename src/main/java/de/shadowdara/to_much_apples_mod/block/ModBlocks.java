package de.shadowdara.to_much_apples_mod.block;
...
public class ModBlocks {
    ...
    public static final RegistryObject<Block> BLAZE_LOG = registerBlock("blaze_log",
            () -> new Block(BlockBehaviour.Properties.copy(Blocks.DIAMOND_BLOCK).sound(SoundType.WOOD)));

    public static final RegistryObject<Block> COMPRESSED_APPLE = registerBlock("compressed_apple",
